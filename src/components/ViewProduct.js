...
export default function ViewProduct({ location, match }) {
  ...
  return (
    <div>
      <div className="uk-card uk-card-default uk-card-hover uk-card-body ">
        <h3 className="uk-card-title">{match.params.name}</h3>
        <ul
        ...
        <div className="uk-flex uk-flex-right uk-margin-top">
          <p data-uk-margin>
            <button className="uk-button uk-button-primary">거 래 요 청</button>
          </p>
        </div>
      </div>
      <br />
      <div className="uk-card uk-card-default uk-card-hover uk-card-body ">
        ...
        <div className="uk-flex uk-flex-right uk-margin-top">
          <p uk-margin>
            <button className="uk-button uk-button-primary">댓 글 작 성</button>
          </p>
        </div>
      </div>
    </div>
